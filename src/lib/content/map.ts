...
export const marketPages: Episode[] = [
  ...
  },
  {
    ...
    summary:
      "Gold price divided by silver price at a dated print. A snapshot, not a fair-value claim. A mining ratio is a different quotient. 1980 and 2011 are the named peak anchors.",
    status: "ready",
    paragraphs: [
