export const FEATURED = [
  {
    ...
    summary: "War finance, the Ruhr, a mark that ceased to work. Then the Rentenmark.",
  ...
  },
  {
    ...
    summary: "The last official gold contract on the dollar. After that, floating fiat.",
