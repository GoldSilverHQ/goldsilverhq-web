...
const physicalSilverDemandByCountry: Section[] = [
  ...
  },
  {
    ...
    paragraphs: [
      "Name the series, the year, and whether you are looking at coin-and-net-bar demand (world **190.9** in 2024), the country physical-investment table (world **183.3**), coins-and-medals fabrication (world **87.9** in 2025), or industrial fabrication (world **657.4** in 2025). Then read the country as a demand address, a mint address, or a factory address. Do not swap the three. A mine-production ranking is a different list, and this site does not keep one here — the mining clock lives on the [gold–silver ratio](/markets/gold-silver-ratio) page and the desk’s [Stocks & flows](/desk) tab. Official gold stocks live on [central-bank gold reserves](/markets/central-bank-gold-reserves). A pair of metal prices, and a dated London vault inventory, live on the [gold–silver ratio](/markets/gold-silver-ratio).",
...
export const marketsHubBody: Section[] = [
  {
    ...
    paragraphs: [
      ...
      "If you arrived asking about **silver mining**, stay with the metal’s books — not company shares. Mine supply is ounces leaving the ground in a survey year. The [gold–silver ratio](/markets/gold-silver-ratio) page keeps that mining clock apart from the market price quotient. [Physical silver demand by country](/markets/physical-silver-demand-by-country) ranks buyers and factories, not holes in the ground. The desk’s [Stocks & flows](/desk) tab shows above-ground metal and mine output beside those articles. No page here names a miner, a ticker, a target, or a reason to prefer one metal.",
