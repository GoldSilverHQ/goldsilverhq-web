...
export const marketsHubBody: Section[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Four doors, four jobs: [official gold book value](/markets/official-gold-book-value) for the statutory **$42.22** versus market arithmetic; [central-bank gold reserves](/markets/central-bank-gold-reserves) for how gold is reported in foreign-exchange reserves and dated official purchases; [gold–silver ratio](/markets/gold-silver-ratio) for the quotient and its three clocks; [physical silver demand by country](/markets/physical-silver-demand-by-country) for identified offtake, fabrication, and scrap-source tables — and for what those rankings do not measure.",
    ],
  },
  {
