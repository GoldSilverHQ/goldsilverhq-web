...
export const twentiethCenturyHubBody: Section[] = [
  {
    heading: "",
    paragraphs: [
      "If you arrived asking **why 1971 mattered**, this chapter is the door: from private rescue after **1907** to the closed gold window. If you arrived asking **what caused Weimar hyperinflation**, the German mark’s collapse has its own article in the same stretch — a dated extreme inside this century, not a synonym for every inflation. In October **1907**, New York trust companies faced a liquidity panic and J. P. Morgan’s group organized private support because no Federal Reserve yet existed. Sixty-four years later, on **15 August 1971**, the United States closed the last official promise that foreign governments could still turn dollars into gold at a fixed price — the **gold window**. Between those dates sit a new central bank, the wartime end of classical gold, a German mark that ceased to work as money, a US recall of private monetary gold, and a postwar dollar system built on official convertibility at **$35** an ounce.",
