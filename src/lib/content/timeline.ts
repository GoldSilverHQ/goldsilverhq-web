...
export const historyTimeline: TimelineStop[] = [
  ...
  },
  {
    ...
    blurb: "A natural gold–silver mix (electrum), a royal stamp, and a cheaper way to check metal.",
  ...
  },
  {
    ...
    blurb: "Rome’s silver denarius and gold aureus: when spending outran metal, the silver coin was lightened.",
  ...
  },
  {
    ...
    blurb: "Both gold and silver legal at a fixed mint ratio — when world prices drifted, one metal left the till.",
  ...
  },
  {
    ...
    year: "1861–65",
    title: "Greenbacks",
    blurb: "Union paper dollars made legal tender in 1862 — then a long fight over when to pay coin again.",
