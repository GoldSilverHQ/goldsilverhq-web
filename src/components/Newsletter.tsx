...
export function Newsletter() {
  ...
  return (
    ...
    >
      <p className="text-xs font-semibold tracking-[0.16em] text-gold uppercase">Newsletter</p>
      <h2 className="mt-2 font-display text-3xl text-fg">Notes from the map</h2>
      <p className="mx-auto mt-3 max-w-md text-muted">
        History and definitions, not tips. Media only — not a recommendation.
      </p>
      {done ? (
